...
if("TRUE" STREQUAL "TRUE")
  set(laser_scan_SOURCE_PREFIX /home/vinit/gym-vinit/src/laser_scan)
  set(laser_scan_DEVEL_PREFIX /home/vinit/gym-vinit/devel)
  ...
  set(laser_scan_INSTALL_PREFIX /home/vinit/gym-vinit/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'laser_scan' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'sharath <sharath@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'laser_scan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vinit/gym-vinit/src/laser_scan/${idir}'.  Ask the maintainer 'sharath <sharath@todo.todo>' to fix it.")
    endif()
...
set(laser_scan_EXPORTED_TARGETS "laser_scan_generate_messages_cpp;laser_scan_generate_messages_lisp;laser_scan_generate_messages_py")
